...
class UpdateController extends CController
{
	...
	public function actionIndex(){
		...
		$new_field=array( 		  
		   'device_platform'=>"varchar(20) NOT NULL DEFAULT ''",
		...
		$new_field=array( 		  
		   ...
		   'single_app_device_uiid'=>"varchar(255) NOT NULL DEFAULT ''"
		);
		$this->alterTable('client',$new_field);
		...
		$this->addIndex('client','device_platform');
		$this->addIndex('client','device_id');
		$this->addIndex('client','enabled_push');
		$this->addIndex('client','registration_type');
		$this->addIndex('client','single_app_merchant_id');
		$this->addIndex('client','social_id');
		$this->addIndex('client','payment_customer_id');
		$this->addIndex('client','single_app_device_uiid');
