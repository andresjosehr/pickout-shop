...
<div class="col-md-3">
	   <div class="radio">
		  <label>
		  <?php 
		  echo CHtml::radioButton('singleapp_startup',
		  getOption($merchant_id,'singleapp_startup')==1?true:false
		  ,array(
		    'id'=>'singleapp_startup',		    
		    'value'=>1
		  ));
		  ?>
		  <?php echo st("Startup 1")?>
		  </label>
		</div>
	...
	<div class="col-md-3">
	   <div class="radio">
		  ...
		  <?php 
		  echo CHtml::radioButton('singleapp_startup',
		  getOption($merchant_id,'singleapp_startup')==2?true:false
		  ,array(
		    'id'=>'singleapp_startup',		    
		    'value'=>2
		  ));
		  ?>
		  <?php echo st("Startup 2")?>
		  </label>
		</div>
		<p class="text-muted"><?php echo st("This will contain a banner where in you can add your own updates,promo,vouchers etc.")?></p>
	</div> <!--col-->
