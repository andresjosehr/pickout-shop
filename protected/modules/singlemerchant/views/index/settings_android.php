...
<div class="form-group">
    ...
    <a id="upload-push-icon" href="javascript:;" class="btn btn-light"><?php echo SingleAppClass::t("Browse")?></a>	    
</div>    
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <a id="upload-push-picture" href="javascript:;" class="btn btn-light"><?php echo SingleAppClass::t("Browse")?></a>	    
   </div>    
