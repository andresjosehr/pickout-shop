...
<p class="between_div"><b><?php echo st("Time Options")?></b></p>

<div class="row">
  <div class="col-md-5">

  <div class="form-group" >
    <label><?php echo SingleAppClass::t("Time Format")?></label>
    <?php 
    echo CHtml::dropDownList('singleapp_time_format',
    getOption($merchant_id,'singleapp_time_format')
    ,array(
      '12'=>SingleAppClass::t("12 hour"),
      '24'=>SingleAppClass::t("24 hours"),
    ),array(
      'class'=>"form-control"
    ));
    ?>    	    
  ...
  <div class="col-md-5">
    ...
    <div class="form-group" >
	    <label ><?php echo SingleAppClass::t("Time Interval")?></label>
	    <?php 
	    echo CHtml::textField('singleapp_time_interval',
	    getOption($merchant_id,'singleapp_time_interval')
	    ,array(
	      'class'=>"form-control numeric_only",
	      'placeholder'=>SingleAppClass::t("Default is 15 mins")
	    ));
	    ?>    	    
	</div>  
...
<p class="between_div"><b><?php echo st("Distance Results")?></b></p>
...
<div class="row">
	...
	<div class="col-md-3">
	   <div class="radio">
		  <label>
		  <?php 
		  echo CHtml::radioButton('singleapp_distance_results',
		  getOption($merchant_id,'singleapp_distance_results')==1?true:false
		  ,array(
		    'id'=>'singleapp_distance_results',		    
		    'value'=>1
		  ));
		  ?>
		  <?php echo st("Using Straight line")?>
		  </label>
		</div>
		<p class="text-muted"><?php echo st("This options does not use any api like google and mapbox for faster results")?></p>
	</div> <!--col-->
	...
	<div class="col-md-3">
	   <div class="radio">
		  ...
		  <?php 
		  echo CHtml::radioButton('singleapp_distance_results',
		  getOption($merchant_id,'singleapp_distance_results')==2?true:false
		  ,array(
		    'id'=>'singleapp_distance_results',		    
		    'value'=>2
		  ));
		  ?>
		  <?php echo st("Using Map Provider")?>
		  </label>
		</div>
		<p class="text-muted"><?php echo st("This options will use api for google and mapbox")?></p>
	</div> <!--col-->
...
<div class="col-md-3">
	<?php echo htmlWrapper::checkbox('singleapp_cart_auto_address','',"Auto Set Address Book", getOption($merchant_id,'singleapp_cart_auto_address') );?>   	
</div>
