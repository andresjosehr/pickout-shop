...
class StoreController extends CController
{
	...
	public function actionIntegrationRegister() {
		$cs = Yii::app()->getClientScript();
		$baseUrl = Yii::app()->baseUrl; 
		...
		$rest_url="../../store/merchantsignup";
		if ($enabled_commission=="yes"){
		   $rest_url="../../store/merchantsignupselection";	
		}        

		$driver_url = "../../store/driver_signup" ;
		$client_url = "../../store/signup" ;

		
		$this->render('integration_register',array(
